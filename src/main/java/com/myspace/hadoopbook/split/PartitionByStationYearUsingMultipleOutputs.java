...
//command line:
//
//export HADOOP_CLASSPATH=target/classes:$HADOOP_CLASSPATH
//hadoop --config conf/hadoop-local.xml com.myspace.hadoopbook.split.PartitionByStationYearUsingMultipleOutputs "input/ncdc/all/190{1,2}.gz" output/partitions2
...
public class PartitionByStationYearUsingMultipleOutputs extends Configured implements Tool {
    ...
    public static void main(String[] args) throws Exception {
        int exit = ToolRunner.run(new PartitionByStationYearUsingMultipleOutputs(), args);
        System.exit(exit);
